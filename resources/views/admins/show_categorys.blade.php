...
<div class="row">
    ...
    <div class="table-agile-info col-lg-10">
        <div class="panel panel-default" style="padding: 2px 2px 15px;">
                ...
                "sorting": {
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-warning" href="{{route('editCategory', $category->id)}}">Sửa</a> - 
                                <a onclick="return confirm('Bạn có chắc muốn xóa danh mục {{$category->name}} ?')" class="btn btn-danger" href="{{route('deleteCategory', $category->id)}}">Xóa</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
            ...
            <a style="margin-left: 20px" class="btn btn-info" href="{{route('addCategory')}}">Thêm mới ngay</a>
            @endif
        </div>
    </div>
	<div class="col-lg-1"></div>
