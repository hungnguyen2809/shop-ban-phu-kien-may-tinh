...
<body>
  ...
  <!-- tittle heading -->
	...
	<div class="copy-right">
		<div class="container">
			<p>
				© {{ date("Y") }} Phụ kiện siêu rẻ | Không đâu rẻ hơn ! 
			</p>
		</div>
	</div>
	<!-- //copyright -->
